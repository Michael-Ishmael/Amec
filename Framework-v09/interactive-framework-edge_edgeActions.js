   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         // add textarea to the div update-it with all the css and stuff
             ...
             $('<p style="font-family:lato, sans-serif;font-size:13px; color:#666666; line-height:15px;" class="update-here1"></p>').appendTo(elek1).css({'left': '0px', 'top': '0px', 'padding-left':'4px',});/// add textarea to placeholder
         ...
         
             {
                 ...
                 $('p.update-here1').html($('.textbox1 textarea').val().replace(/\n/g,"<br>"));
         ...
         // add textarea to the div update-it with all the css and stuff
             ...
             function update12()
             {
                 $('p.update-here1-2').html($('.textbox1-2 textarea').val().replace(/\n/g,"<br>"));
             } // add input to textarea
