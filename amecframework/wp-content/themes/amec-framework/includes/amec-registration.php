...
<div class="control-row row">
    ...
    <div class="col-md-2 low-pad-cell">
        <div class="button background-yellow bottom-dark-border-yellow">Save Progress</div>
    </div>
    <div class="col-md-1 low-pad-cell">
        <div id="show_signup" class="button background-bright_green bottom-dark-border-bright_green">Submit</div>
    </div>
</div>
<div class="login-row row" id="login_row">
    <div class="col-md-4" id="login_box">
        <form id="login" class="ajax-auth-2" action="login" method="post">
    ...
    <div class="col-md-4" id="register_box">
        <form id="register" class="ajax-auth-2"  action="register" method="post">
